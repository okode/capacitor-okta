...
export interface OktaPlugin {
  signIn(options?: { signInInBrowser?: boolean, document?: string, params?: Record<string, string> }): Promise<{ token: string }>;
  ...
  configure(options: { config: OktaConfig, cleanStorage?: boolean }): Promise<void>;
